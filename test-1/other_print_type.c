...
/**
 * _printf_hex - prints a hexadecimal in lower case
...
/**
 * _printf_HEX - prints a hexadecimal in upper case
 * @arg: list that contains hexadecimal to print
 * Return: number of digits printed
 */
...
/**
 * _printf_unsignedToBinary - prints an integer.
 * @arg: argument
 * Return: 0
 */
...
/**
 * _printf_oct - prints number in octal base.
...
/**
 * _printf_unsignedIntToHex - prints unsigned int to hexadecimal.
 * @num: number to print
